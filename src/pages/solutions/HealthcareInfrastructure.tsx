          ...
          <div className="container mx-auto px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { title: "API Solutions", url: "/solutions/api-solutions", description: "Integrate infrastructure via API" },
                  { title: "Coverage Expansion", url: "/solutions/coverage-expansion", description: "Expand to Tier-2/3 markets instantly" },
                  { title: "Digital Health Platforms", url: "/who-we-serve/digital-health-platforms", description: "For healthtech companies" },
                  { title: "Scaling to Tier-2/3", url: "/resources/blog/scaling-tier2-tier3", description: "How to expand nationwide" }
                ].map((link, index) => (
