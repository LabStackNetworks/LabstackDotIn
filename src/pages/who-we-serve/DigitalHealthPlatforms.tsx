            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  { title: "Healthcare Infrastructure", url: "/solutions/healthcare-infrastructure", description: "Complete infrastructure platform" },
                  { title: "Providers Network", url: "/who-we-serve/providers", description: "Quality-assured provider network" },
                  { title: "Digital Health Scale", url: "/resources/blog/digital-health-scale", description: "How healthtech platforms scale fast" }
                ].map((link, index) => (
