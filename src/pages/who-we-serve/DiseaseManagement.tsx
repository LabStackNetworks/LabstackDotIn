          ...
          <div className="container mx-auto px-6">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { title: "Consultations Platform", url: "/platform/consultations", description: "Teleconsult and in-clinic for care pathways" },
                  { title: "Diagnostics Platform", url: "/platform/diagnostics", description: "Home sample collection for chronic monitoring" },
                  { title: "Digital Health Platforms", url: "/who-we-serve/digital-health-platforms", description: "For digital health companies" },
                  { title: "Disease Management Case Study", url: "/resources/case-studies/disease-management", description: "How care programs achieve 90%+ completion" }
                ].map((link, index) => (
